...
//     if(!Boolean(computerData.computer_name))
//       errors.computer_name="Computer Name is required.";
...
//     <>
//       <Helmet>
//         <title>Computer Create | REFEX ITAM</title>
//       </Helmet>
...
//       >
//         <DialogTitle>{"Create a new Computer Asset"}</DialogTitle>
//         <DialogContent>
...
//                   required
//                   label="Computer Name"
//                   value={countryData.computer_name}
//                   onChange={(event) => {
